...
include_once "../models/OrganizadorModel.php";
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="evento.php">Eventos</a>
                </li>
                <li class="nav-item">
        ...
        <?php foreach ($eventos as $evento) : ?>
            <div class="col">
                <div class="card h-100 evento-card">
                    <img src="../public/img/eventos/<?= htmlspecialchars($evento['imagen'] ?? 'default.jpg') ?>" 
                    ...
                    <div class="card-footer bg-white">
                        <div class="d-flex justify-content-between">
                            <a href="evento.php?action=ver&id=<?= $evento['id_evento'] ?>" class="btn btn-sm btn-outline-primary">
